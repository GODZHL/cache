...
import cn.stu.cache.CacheChannel;
import cn.stu.cache.CacheObject;
import net.sf.ehcache.config.CacheConfiguration;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import cn.stu.cache.CacheExpiredListener;
import cn.stu.cache.CacheProvider;
import net.sf.ehcache.CacheManager;

/**
 * EhCache 2.x 缓存管理器的封装，用来管理多个缓存区域
 *
 * @author zhanghanlin (javayou@gmail.com)
 */
